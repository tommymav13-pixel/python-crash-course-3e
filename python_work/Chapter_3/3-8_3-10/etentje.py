...
#tellen van de gastenlijst
print("Aantal gasten in de lijst:", len(gastenlijst))

print("Ik moet de gastenlijst nu helemaal leegmaken.")

del gastenlijst[0]
del gastenlijst[0]
print(gastenlijst) 

print("De gastenlijst is nu leeg:", gastenlijst)